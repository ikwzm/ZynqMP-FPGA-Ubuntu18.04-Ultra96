### Format SD-Card for Ultra96/Ultra96-V2
...
1. run scripts/format-disk-ultra96.sh
2. run fdisk step-by-step (not discussed here)
3. run other tools(not discussed here)


#### scripts/format-disk-ultra96.sh

```sh:scripts/format-disk-ultra96.sh
...
shell# sh scripts/format-disk-ultra96.sh
